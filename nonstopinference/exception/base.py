...
class ExceptionRecord:
    def __init__(self, data, data_id, block_id, status, error_msg):
        self.data = data
...
class ExceptionLogger:
    def __init__(self, name, log_dir=None, log_callback=None) -> None:
        self.name = name
    ...
    def log(
        self, data, data_id: str, block_id: str, status: str, error_msg: str
    ) -> None:
        exception_record = ExceptionRecord(
            data, data_id, block_id, status, error_msg
        )
